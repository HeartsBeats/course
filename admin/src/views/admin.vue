    ...
    <div class="main-container ace-save-state" id="main-container">
      <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
        ...
        <ul class="nav nav-list">
          ...
          <li class="">
            <a v-show="hasResource('02')" class="dropdown-toggle">
              <i class="menu-icon fa fa-list"></i>
            ...
            <ul class="submenu">
              <li v-show="hasResource('0201')" id="business-category-sidebar">
              ...
              <li v-show="hasResource('0202')" id="business-course-sidebar">
          ...
          <li class="">
            <a v-show="hasResource('03')" class="dropdown-toggle">
              <i class="menu-icon fa fa-list"></i>
            ...
            <ul class="submenu">
              <li v-show="hasResource('0301')" id="file-file-sidebar">
        ...
        <div class="footer-inner">
          <div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Heart</span>
