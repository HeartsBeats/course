    ...
    private RoleResourceMapper roleResourceMapper;
        ...
        */
        public void list(PageDto pageDto) {
            ...
            List
            <RoleResourceDto> roleResourceDtoList = CopyUtils.copyList(roleResourceList, RoleResourceDto.class);
        ...
        */
        public void save(RoleResourceDto roleResourceDto) {
            RoleResource roleResource = CopyUtils.copy(roleResourceDto, RoleResource.class);
